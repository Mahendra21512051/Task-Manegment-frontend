    ...
    const fetchCategories = async () => {
      ...
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Categorymanegment?UserId=${user.id}`
        );
    ...
    if (result.isConfirmed) {
      try {
        const response = await axios.delete(
          `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Categorymanegment/${categoryId}`
        );
