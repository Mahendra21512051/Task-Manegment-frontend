      ...
      const fetchCategory = async () => {
        try {
          const { data } = await axios.get(
            `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Categorymanegment/getById/${id}`
          );
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (id) {
        ...
        await axios.patch(
          `${ import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Categorymanegment/${id}`,
          {
            Category: category,
            Status: status,
          }
        ...
        // Create new category
        await axios.post(
          `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Categorymanegment`,
          {
            UserId: user.id,
            Category: category,
            Status: status,
