...
const AddNewTask = () => {
  ...
  const fetchCategories = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Categorymanegment/getstatus?UserId=${user.id}`
      );
  ...
  const fetchTask = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Taskmanegment/${id}`
      );
  ...
  const saveDataHandler = async () => {
    ...
    try {
      ...
      if (id) {
        await axios.patch(
          `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Taskmanegment/single/${id}`,
          taskData
        );
      } else {
        await axios.post(
          `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/Taskmanegment`,
          taskData
        );
      }
  ...
  const fetchFriends = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL}/clustertaskmanagment/connectionmanegment/getFriends/${user.id}`
      );
      ...
      if (response.data && response.data.friends) {
        ...
        const sharedResponse = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/shareTaskmanegment/getShareTask?taskId=${id}`
        );
  ...
  const addFriendToList = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/shareTaskmanegment/shareTask`,
        newFriendData
      );
  ...
  try {
    await axios.delete(
      `${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/shareTaskmanegment/removeSharedTask/${shareId}`
    );
  ...
  const updateResponsibility = async (friendId, newPermission) => {
    try {
      await axios.patch(`${import.meta.env.VITE_BACKEND_URL}/Clustertaskmanagment/shareTaskmanegment/updateSharedTaskPermission/${friendId}`, { newPermission });
